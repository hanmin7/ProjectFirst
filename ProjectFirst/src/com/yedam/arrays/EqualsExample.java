...
public class EqualsExample {
	public static void main(String[] args) {
		...
		System.out.println("배열 번지 비교 : " + original.equals(cloned1)); //ori==clo false 각각 다른번지에 생성.
		...
		System.out.println("중첩 배열 항목값 비교 : " + Arrays.deepEquals(original, cloned2));//2차배열의 값을 비교 true	
	}
}
